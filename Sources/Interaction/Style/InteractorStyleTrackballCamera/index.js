...
function vtkInteractorStyleTrackballCamera(publicAPI, model) {
  ...
  publicAPI.handleMouseMove = (callData) => {
    ...
    const renderer = publicAPI.getRenderer(callData);
  ...
  publicAPI.updateCameraPose = (ed) => {
    ...
    // controller
    const camera = publicAPI.getRenderer(ed).getActiveCamera();
  ...
  publicAPI.handlePan = (callData) => {
    const camera = publicAPI.getRenderer(callData).getActiveCamera();
    ...
    if (model._interactor.getLightFollowCamera()) {
      publicAPI.getRenderer(callData).updateLightsGeometryToFollowCamera();
    }
  ...
  publicAPI.handleMouseWheel = (callData) => {
    ...
    publicAPI.dollyByFactor(publicAPI.getRenderer(callData), dyf);
  };
